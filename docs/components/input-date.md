...
can keep typing, while ↓ opens it and moves focus into the grid. That
...
`<button>`s you render into it (click and keyboard: arrows, Home/End,
PageUp/PageDown), holds the submitted value via `ElementInternals`,
