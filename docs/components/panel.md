...
do not restore the panel. Panel adds no dialog role or background inertness.
Maximizing Panel does not lock page scrolling; the page's viewport scrollbar
may remain visible and usable. Use [Dialog](./dialog.md) for modal interactions.
