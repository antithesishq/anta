...
export async function generate({ input, output = '.', name = 'a-icon.shapes', internal = false } = {}) {
  ...
  const shapes = []
  // Anta's per-element CSS lives in `@layer anta.components`. Consumer-generated
  ...
  // Close the `@layer anta.components {` block opened at the top of cssLines.
  cssLines.push('}')
