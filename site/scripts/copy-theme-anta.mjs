 ...
 * site/public/themes/ so the palette <link> in DocsLayout.astro can point at
 * `/themes/anta.css`. Runs as part of the `docs` pre-step, and re-runs on every
...
const dest = fileURLToPath(new URL('../public/themes/anta.css', import.meta.url))
