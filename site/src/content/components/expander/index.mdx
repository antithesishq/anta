...
import { Expander, Text, Button, ButtonCopy, Icon, Title } from '@antadesign/anta'
...
<Preview direction="column" gap="8px">
  <Expander round title="Round — click to expand" priority="primary">
    <Text>The corners stay at the folded pill's radius while the body is revealed, rather than re-rounding to half this taller box.</Text>
  </Expander>
</Preview>
...
<Preview direction="column" gap="8px">
  <a-expander indicator-placement="end">
    <a-expander-summary slot="title">Download report</a-expander-summary>
    <Button slot="actions" size="small" label="Download" />
    <a-expander-details><Text>The indicator and title toggle this section. Download is a separate action.</Text></a-expander-details>
  </a-expander>
  <a-expander indicator="plus" indicator-placement="end">
    <a-expander-summary slot="title">Plus and minus</a-expander-summary>
    <a-expander-details><Text>The vertical stroke folds away when open.</Text></a-expander-details>
  </a-expander>
</Preview>
...
<Preview direction="column" gap="8px">
  <a-expander default-state="open">
    <a-expander-summary slot="title">Debug timeline <ButtonCopy copy="2026-07-20T12:00:00Z — event log" icon="copy" size="small" priority="tertiary" /></a-expander-summary>
    <a-expander-details><Text>Clicking the copy button copies the timeline; the section stays open.</Text></a-expander-details>
  </a-expander>
</Preview>
...
<Preview align="stretch">
  <a-expander default-state="open">
    <a-expander-summary slot="title">Build artifacts</a-expander-summary>
    <a-button slot="actions" role="button" tabindex="0" size="small"><a-button-label>Share</a-button-label></a-button>
...
<Preview align="center">
  <details data-anta priority="secondary" tone="info" round level="3" open>
    ...
    <div>Everything inside <code>&lt;details&gt;</code> is the collapsible body.</div>
  </details>
</Preview>
...
<Preview direction="column" gap="8px">
  <Expander title="Triangle indicator" indicator="triangle" priority="tertiary">
    <Text>The triangle follows the open state.</Text>
  </Expander>
</Preview>
...
<Preview direction="column" gap="8px">
  <a-expander class="indicator" indicator-placement="end" default-state="open">
    <a-expander-summary slot="title">Build log</a-expander-summary>
    <a-expander-details><Text>The indicator belongs to the summary button.</Text></a-expander-details>
  </a-expander>
  <style is:inline>{`
