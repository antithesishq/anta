...
{/* Inputs sit on bg-1, so lift preview panels to bg-2. The priority preview uses
    bg-4 to show the difference between a filled and transparent field.
    Page-scoped; !important beats Preview's scoped default (--bg-canvas). */}
<style is:inline>{`
  .preview { background: var(--bg-2) !important; }
  .priority-preview .preview { background: var(--bg-4) !important; }
`}</style>
...
<Preview>
  ...
  <Input size="medium" label="Medium" placeholder="28px tall" autoComplete="off" />
...
<Preview>
  <Input multiline label="Bio (autogrows)" placeholder="Tell us about yourself…" maxRows={6} autoComplete="off" />
  <Input multiline rows={3} label="Notes (fixed 3 rows)" placeholder="Scrolls past 3 rows" autoComplete="off" />
</Preview>
...
<Preview cols={1}>
  <Input type="text" label="Text" placeholder="Plain text" autoComplete="off" />
  ...
  <Input type="tel" label="Tel" placeholder="+1 555 0100" autoComplete="tel" />
  <Input type="url" label="URL" placeholder="https://example.com" autoComplete="url" />
  <Input type="number" label="Number" placeholder="0" min={0} max={100} autoComplete="off" />
</Preview>
...
<Preview>
  <Input className="label-side" label="Display name" hint="Shown on your profile" placeholder="Ada Lovelace" autoComplete="name" style={{ width: '100%', maxWidth: '440px' }} />
  <style is:inline>{`
    a-input.label-side {
...
<Preview>
  <div className="aligned-form" style={{ width: '100%', maxWidth: '460px' }}>
    <Input label="Email" type="email" autoComplete="email" hint="We'll never share it." placeholder="you@example.com" />
    <Input label="Confirm password" type="password" autoComplete="new-password" placeholder="••••••••" />
    <Input label="PIN" autoComplete="one-time-code" placeholder="0000" />
  </div>
  <style is:inline>{`
...
<Preview>
  <Input className="hint-right" label="Username" hint="3–20 characters" placeholder="ada" autoComplete="username" style={{ width: '100%', maxWidth: '360px' }} />
  <style is:inline>{`
    a-input.hint-right {
...
<Preview>
  <div className="wrap-fields" style={{ width: '100%', maxWidth: '520px' }}>
    <Input label="First name" placeholder="Ada" autoComplete="given-name" />
    <Input label="Last name" placeholder="Lovelace" autoComplete="family-name" />
    <Input label="Email" type="email" placeholder="you@example.com" autoComplete="email" />
    <Input label="Phone" type="tel" placeholder="+1 555 0100" autoComplete="tel" />
  </div>
  <style is:inline>{`
...
<Preview gap="16px">
  <input data-anta data-anta-size="small" style={{ marginBottom: '8px' }} type="text" name="name" placeholder="Small text" />
  <input data-anta style={{ marginBottom: '8px' }} type="search" name="search" placeholder="Search" />
  <input data-anta style={{ marginBottom: '8px' }} type="email" name="email" placeholder="Email" />
  <input data-anta style={{ marginBottom: '8px' }} type="tel" name="phone" placeholder="Telephone" />
  <input data-anta round style={{ marginBottom: '8px' }} type="url" name="site" placeholder="Rounded URL" />
  <input data-anta style={{ marginBottom: '8px' }} type="password" name="password" value="password" />
  <input data-anta tone="rebeccapurple" style={{ marginBottom: '8px' }} type="number" name="seats" value="3" min="1" />
  <textarea data-anta rows="3" style={{ marginBottom: '8px', width: '100%' }} name="notes" placeholder="Notes" />
  <input data-anta style={{ marginBottom: '8px' }} type="file" name="attachment" accept=".pdf,.docx" />
  <input data-anta style={{ marginBottom: '8px' }} type="submit" value="Submit" priority="primary" />
  <input data-anta style={{ marginBottom: '8px' }} type="reset" value="Reset" />
</Preview>
...
<Preview>
  <Input className="fancy" label="Email" type="email" autoComplete="email" placeholder="you@example.com" />
  <style is:inline>{`
...
<Disclosure title="Placeholder contrast" level={3}>
