...
import MenuSwitchDemo from '../../../components/MenuSwitchDemo'
...
<Preview>
  ...
  <Menu inset={8}>
    <a-menu-header slot="header" data-menu-open>
      <Input size="small" placeholder="Filter…" aria-label="Filter items" />
    </a-menu-header>
...
[Select](/select/)'s selection modes use the checkbox and radio variants.
