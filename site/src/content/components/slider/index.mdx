...
import sliderDemoCode, { editableCode as sliderEditableDemoCode } from './slider.demo.ts'
...
<Playground
  ...
  layout="side"
  panelHeight={360}
  initialCode={sliderEditableDemoCode}
  initialCss={`.preview { min-height: 100%; align-items: center; justify-content: center; }
.editable-slider {
  display: grid;
