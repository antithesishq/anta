...
<Preview minHeight={308}>
  <PlotCustomPreview example="highlights" />
</Preview>
...
<Preview minHeight={308}>
  <PlotInteractionPreview example="composedTooltips" />
</Preview>
...
<Preview minHeight={308}>
  <PlotDetailPreview example="fontRoles" label="Different fonts by role" />
</Preview>
...
<Preview minHeight={308}>
  <PlotDetailPreview example="fontOverrides" label="Shared settings and local overrides" />
</Preview>
