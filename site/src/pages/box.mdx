...
<Preview align="stretch" gap="16px" justify="flex-start">
  <Box reportMeasure round={8} className="edge" style={{ width: '150px' }}>Content that fits.</Box>
  <Box reportMeasure round={8} className="edge" style={{ width: '150px', overflow: 'hidden', whiteSpace: 'nowrap' }}>
    A label too long for this box.
  </Box>
  <Box reportMeasure round={8} className="edge" style={{ width: '150px', height: '56px', overflowY: 'auto' }}>
