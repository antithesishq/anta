...
import { CapturePointerPreview, CapturePanPreview } from '../components/CaptureGesturePreview.tsx'
...
<Preview align="stretch">
  <CapturePointerPreview client:only="preact" />
  <style is:inline>{`
    .pointer-probe { display: grid; gap: 12px; width: 100%; }
    .pointer-probe-controls { display: flex; flex-wrap: wrap; align-items: center; gap: 8px; }
...
<Preview align="stretch">
  <CapturePanPreview client:only="preact" />
  <style is:inline>{`
    .pan-probe { display: grid; gap: 12px; width: 100%; }
    .pan-probe-controls { display: flex; flex-wrap: wrap; align-items: center; gap: 8px; }
