...
<Preview gap="16px">
  <Checkbox tone="brand" toneScope="selected">Off — neutral</Checkbox>
  <Checkbox defaultChecked tone="brand" toneScope="selected">On — brand</Checkbox>
  <Checkbox defaultChecked tone="critical" toneScope="selected">On — critical</Checkbox>
</Preview>
