...
`tone` colours only the **mark** — the checked-box fill and the checkmark glyph. The
unselected box border always stays the neutral grey regardless of tone, so it stays
visible as a thin `1px` line against any background. The label and hint stay neutral.
...
<Preview gap="16px">
  <Checkbox toneSelected="brand">Off — neutral</Checkbox>
  <Checkbox defaultChecked toneSelected="brand">On — brand</Checkbox>
  <Checkbox defaultChecked toneSelected="critical">On — critical</Checkbox>
</Preview>
...
By default, the checkbox box aligns to the **top of the first line** when labels wrap to multiple lines. Use `alignItems="center"` to center the checkbox vertically on the text instead.

<Preview gap="20px">
  <Checkbox defaultChecked label="Enable notifications for important updates and new features. When this option is enabled, you will receive real-time alerts for all critical system events and announcements from the administration team." />
  <Checkbox defaultChecked alignItems="center" label="Enable notifications for important updates and new features. When this option is enabled, you will receive real-time alerts for all critical system events and announcements from the administration team." />
</Preview>

```tsx folded
<Checkbox defaultChecked label="Enable notifications for important updates and new features..." />
<Checkbox defaultChecked alignItems="center" label="Enable notifications for important updates and new features..." />
```
