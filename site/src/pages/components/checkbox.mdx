...
<Preview gap="16px">
  <Checkbox defaultChecked label="Top-aligned (default)" hint="Label text wraps to multiple lines and checkbox stays at the top edge of the first line." />
  <Checkbox defaultChecked alignItems="center" label="Center-aligned" hint="Label text wraps to multiple lines and checkbox centers vertically." />
</Preview>

```tsx folded
<Checkbox defaultChecked label="Top-aligned (default)" hint="..." />
<Checkbox defaultChecked alignItems="center" label="Center-aligned" hint="..." />
```
