...
Menu-level selection affordances — a checkmark, and single- vs multi-select
semantics — are coming next. Today `selected` is the visual state you drive.
...
<Preview>
  ...
  <Menu>
    <MenuItem icon="folder-open" label="Active"><Tag size="small" tone="info">12</Tag></MenuItem>
    <MenuItem icon="folder-close" label="Archived" />
