...
**Sections** — grouped options under a heading, the way `MenuGroup` does for menus —
aren't built yet. Creating a new option from the filter query needs no dedicated
feature: return a "Create …" row from `renderEmpty`.
