...
a substantial amount of code. If you only need people to enter a value, use a
native input with `data-anta` for the same field appearance.

<Preview>
  <input data-anta type="text" placeholder="Search people" />
</Preview>
