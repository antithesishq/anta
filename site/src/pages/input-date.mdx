...
`InputDate` has no host element. Compose a calendar from controls and an
`<a-calendar>` day grid; the grid owns selection and keyboard movement.

<Preview>
  <a-calendar role="group" name="due-date">
    <a-button role="button" tabindex="0" priority="tertiary" data-part="day-cell" data-date="2026-06-27"><a-button-label>27</a-button-label></a-button>
    <a-button role="button" tabindex="0" priority="tertiary" data-part="day-cell" data-date="2026-06-28"><a-button-label>28</a-button-label></a-button>
    <a-button role="button" tabindex="0" priority="tertiary" data-part="day-cell" data-date="2026-06-29"><a-button-label>29</a-button-label></a-button>
  </a-calendar>
</Preview>
