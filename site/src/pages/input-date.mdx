...
<kbd>↓</kbd> opens the menu and moves focus to the grid. The wrapper passes a
...
`<button>`s to click and keyboard navigation, including arrows, <kbd>Home</kbd>,
<kbd>End</kbd>, <kbd>PageUp</kbd>, and <kbd>PageDown</kbd>. It stores the form
