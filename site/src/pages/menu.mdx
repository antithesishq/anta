...
An open menu is an `<a-menu>` with light-DOM `<a-menu-item>` rows.

<Preview>
  <a-menu role="menu" state="open">
    <a-menu-item role="menuitem" value="settings"><a-menu-item-label>Settings</a-menu-item-label></a-menu-item>
    <a-menu-item role="menuitem" value="members"><a-menu-item-label>Members</a-menu-item-label></a-menu-item>
  </a-menu>
</Preview>
