...
<Preview>
  <a-progress value="42" max="100" role="progressbar" aria-valuenow="42" aria-valuemin="0" aria-valuemax="100" aria-label="Upload, 42%">
    <a-progress-label>
...
```html folded
<a-progress value="42" max="100" role="progressbar"
