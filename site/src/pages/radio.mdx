...
<Preview>
  <div style={{ display: 'grid', gap: '8px', marginBottom: '8px' }}>
    <label><input data-anta type="radio" name="native-plan" value="starter" size="small" tone="brand" /> Starter</label>
    <label><input data-anta type="radio" name="native-plan" value="pro" tone="success" tone-scope="selected" checked /> Pro</label>
    <label><input data-anta type="radio" name="native-plan" value="enterprise" size="large" tone="warning" /> Enterprise</label>
  </div>
</Preview>
