...
[`Input`](/input/): `critical`, `warning`, `success`, `info`, `brand`
...
<Preview style="flex-direction: column; align-items: flex-start;">
  <label><input data-anta type="radio" name="native-plan" value="starter" /> Starter</label>
  <label style={{ marginBottom: '8px' }}><input data-anta type="radio" name="native-plan" value="pro" checked /> Pro</label>
</Preview>

```html
<label><input data-anta type="radio" name="plan" value="starter"> Starter</label>
<label><input data-anta type="radio" name="plan" value="pro" checked> Pro</label>
```
...
text-tone prop. The focus ring is the global [`--focus-ring`](/colors/#focus-ring).
