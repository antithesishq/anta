...
closes when a user clicks outside it or presses <kbd>Esc</kbd>.

Select uses an [Input](/input/) for its field and a [Menu](/menu/) for its
...
<Preview>
  <SelectOptionsDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectModesDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
select that row. On macOS, use <kbd>Option</kbd> instead of <kbd>Alt</kbd>.
...
<Preview>
  <SelectFilterDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
Opening the dialog focuses the search field. <kbd>↑</kbd> and <kbd>↓</kbd> move
through matching options while focus stays in that field. <kbd>Enter</kbd>
selects the active option, and <kbd>Esc</kbd> closes the dialog. The search field
...
<Preview>
  <SelectControlledDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectSelectionTreeDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectSizeStatusDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectBasicDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectRenderOptionDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectTruncateDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectRenderIndicatorDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectSummaryDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectTriggerDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectColumnsDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectEmptyDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview>
  <SelectGroupsDemo client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview align="stretch">
  <WebComponentComposition kind="select">
...
<Preview>
  <select data-anta data-anta-size="small" round style={{ marginBottom: '8px' }} name="native-output">
    <button>
...
<Preview>
  <SelectGhostDemo client:visible={{ rootMargin: '200px' }} />
  <style is:inline>{`
