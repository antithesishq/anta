...
field inside the menu. <kbd>↑</kbd> and <kbd>↓</kbd> move through matching options
while focus stays in that field. <kbd>Enter</kbd> selects the active option, and
<kbd>Esc</kbd> closes the menu. The search field stays visible while the results
