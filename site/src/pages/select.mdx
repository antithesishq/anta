...
<Preview align="stretch">
  <div style={{ display: 'grid', gap: '4px', width: '280px' }}>
    <a-input readonly value="stream" aria-haspopup="menu" aria-expanded="true">
    ...
    <a-menu role="menu" state="open">
      <a-menu-item role="menuitemradio" value="output_text"><a-menu-item-label>output_text</a-menu-item-label></a-menu-item>
      <a-menu-item role="menuitemradio" value="stream" selected><a-menu-item-label>stream</a-menu-item-label></a-menu-item>
    </a-menu>
  </div>
</Preview>
