...
import { State, Priority, Tones, Customization, Sizes, Vertical, ComposedNavigation, DottedConnectorStyle, FullWidthSteps } from '../components/StepsDemo'
...
<Preview background="var(--bg-base)" align="stretch" minHeight={210}>
  <State client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview background="var(--bg-base)" align="stretch">
  <Priority client:visible={{ rootMargin: '200px' }} />
</Preview>
...
<Preview background="var(--bg-base)" align="stretch">
  <FullWidthSteps client:visible={{ rootMargin: '200px' }} />
</Preview>
